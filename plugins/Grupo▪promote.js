...
if(number.length > 13 || (number.length < 11 && number.length > 0)) return conn.reply(m.chat, `[🚫] 𝐄𝐥 𝐧𝐮𝐦𝐞𝐫𝐨 𝐢𝐧𝐠𝐫𝐞𝐬𝐚𝐝𝐨 𝐞𝐬 𝐢𝐧𝐜𝐨𝐫𝐫𝐞𝐜𝐭𝐨, 𝐢𝐧𝐠𝐫𝐞𝐬𝐞 𝐮𝐧𝐨 𝐯𝐚𝐥𝐢𝐝𝐨`, m)
...
conn.reply(m.chat, `[↪️] 𝐀𝐡𝐨𝐫𝐚 𝐞𝐬 𝐚𝐝𝐦𝐢𝐧 𝐝𝐞 𝐞𝐬𝐭𝐞 𝐠𝐫𝐮𝐩𝐨`, m)
}}
