...
${isWin ? `@${(isSurrender ? room.game.currentTurn : room.game.winner).split('@')[0]} ganaste 🥳, te llevas 4999 de exp` : isTie ? 'el juego terminó en empate 😐' : `turno de @${room.game.currentTurn.split('@')[0]}`}
`.trim()
