...
async function addExif(webpSticker, packname, author, categories = [''], extra = {}) {
  ...
  const json = { 'sticker-pack-id': 'NyanCat_Is_God', 'sticker-pack-albert': 'From ALBERTO9883', 'sticker-pack-script': 'https://github.com/ALBERTO9883', 'sticker-pack-name': packname, 'sticker-pack-publisher': author, 'emojis': '🍇🐢🍘🫐🌺🪴🎋🍉🥗🪽', ...extra };
